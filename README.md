...
This is a responsive e-commerce web application.
...
index.html - product feed (homepage)
...
16.04.26
Compleated HTML structure for all pages (home, product, cart, checkout,success)
...
Fetch products from Noroff Online Shop API
